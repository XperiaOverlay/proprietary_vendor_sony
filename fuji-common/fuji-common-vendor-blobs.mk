# Copyright (C) 2014 Xperia Overlay
#
...
PRODUCT_COPY_FILES += \
    ...
    $(COMMON_PATH)/proprietary/system/etc/firmware/fw_bcm4330b1.bin:system/etc/firmware/fw_bcm4330b1.bin \
    $(COMMON_PATH)/proprietary/system/etc/firmware/fw_bcm4330b1_apsta.bin:system/etc/firmware/fw_bcm4330b1_apsta.bin \
    $(COMMON_PATH)/proprietary/system/etc/firmware/fw_bcm4330b2.bin:system/etc/firmware/fw_bcm4330b2.bin \
    $(COMMON_PATH)/proprietary/system/etc/firmware/fw_bcm4330b2_apsta.bin:system/etc/firmware/fw_bcm4330b2_apsta.bin \
    $(COMMON_PATH)/proprietary/system/etc/firmware/fw_bcm4330b2_p2p.bin:system/etc/firmware/fw_bcm4330b2_p2p.bin \
